            ...
            "properties": {
                ...
                "container": {
                    ...
                    "properties": {
                        ...
                        "libraries": {
                            "description": "Libraries to be downloaded before server startup.",
                            "type": [
                                "string",
                                "null"
                            ]
                ...
                "logging": {
                    ...
                    "properties": {
                        "console": {
                            "description": "Configures the console (stdout) log output format.",
                            "properties": {
                                "json": {
                                    "description": "Set to true to output logs as JSON on stdout for log aggregation (ELK, Loki, etc.). Adds time, service, namespace, and pod fields to each log entry.",
                                    "default": false,
                                    "type": "boolean"
                                }
                            },
